    ...
    methods: {
            ...
            GlobalService.getData("/report/list-reports")
                .then((response) => {
                    this.rows = response.reports.map((report) => ({
                        ...
                        web: report.web,
                        companyNameUpdate: report.companyNameUpdate,
                        companyFloorNumberUpdate: report.companyFloorNumberUpdate,
                        companyStreetUpdate: report.companyStreetUpdate,
                        companyCityUpdate: report.companyCityUpdate,
                        companyStateUpdate: report.companyStateUpdate,
                        companyFaxNumberUpdate: report.companyFaxNumberUpdate,
                        companyEmailAddressUpdate: report.companyEmailAddressUpdate,
                        companyPhoneNumberOneUpdate: report.companyPhoneNumberOneUpdate,
                        companyPhoneNumberSecondUpdate: report.companyPhoneNumberSecondUpdate,
        ...
        downloadReports() {
            const headersMap = {
                ...
                web: 'Página Web',
                companyNameUpdate: 'Nombre de la Compañía (Actualización)',
                companyFloorNumberUpdate: 'Número de Piso de la Compañía (Actualización)',
                companyStreetUpdate: 'Calle de la Compañía (Actualización)',
                companyCityUpdate: 'Ciudad de la Compañía (Actualización)',
                companyStateUpdate: 'Estado de la Compañía (Actualización)',
                companyFaxNumberUpdate: 'Número de Fax de la Compañía (Actualización)',
                companyEmailAddressUpdate: 'Correo Electrónico de la Compañía (Actualización)',
                companyPhoneNumberOneUpdate: 'Teléfono 1 de la Compañía (Actualización)',
                companyPhoneNumberSecondUpdate: 'Teléfono 2 de la Compañía (Actualización)',
