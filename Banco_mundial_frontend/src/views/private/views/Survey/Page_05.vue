    ...
    <div class="flex justify-center">
        <form class="space-y-4 text-center">
            ...
            <div class="flex items-center">
                <input id="Si" name="A7" type="radio" value="1" v-model="A7_val" class="h-4 w-4 text-blue-600 border-gray-300 focus:ring-blue-500">
                <label for="Si" class="ml-3 block text-sm font-medium text-gray-700">Sí</label>
            </div>
            <div class="flex items-center">
                <input id="No" name="A7" type="radio" value="2" v-model="A7_val" class="h-4 w-4 text-blue-600 border-gray-300 focus:ring-blue-500">
